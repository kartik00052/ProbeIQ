...
class ProfileService:
    ...
    def build(self, analysis: CandidateAnalysis) -> CandidateInterviewProfile:
        ...
        return CandidateInterviewProfile(
            ...
            commit_days=analysis.candidate.signals.commitDays,
            missions_completed=analysis.candidate.signals.missionsCompleted,
            missions_first_try=analysis.candidate.signals.missionsFirstTry,
