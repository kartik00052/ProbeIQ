...
def build_generate_question(
    ...
    def generate_question(state: InterviewGraphState) -> dict:
        ...
        context = QuestionContext(
            ...
            commit_days=session.candidate_profile.commit_days,
            missions_completed=session.candidate_profile.missions_completed,
            missions_first_try=session.candidate_profile.missions_first_try,
            day=topic.day,
            topic=topic.title,
